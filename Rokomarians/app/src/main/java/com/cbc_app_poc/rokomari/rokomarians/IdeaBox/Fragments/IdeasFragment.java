...
public class IdeasFragment extends Fragment {
    ...
    private RecyclerAdapterIdeas recyclerAdapterIdeas;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recyclerview_idea);
    ...
    private class GetDataFromServer extends AsyncTask< Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            recyclerAdapterIdeas = new RecyclerAdapterIdeas(getContext(), data);
            recyclerView.setAdapter(recyclerAdapterIdeas);
        }
