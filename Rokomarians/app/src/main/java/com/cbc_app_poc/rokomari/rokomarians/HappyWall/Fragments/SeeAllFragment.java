...
public class SeeAllFragment extends Fragment {
    ...
    private RecyclerAdapterSeeAll recyclerAdapterSeeAll;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recyclerview_see_all_happy_wall);
    ...
    private class GetDataFromServer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            recyclerAdapterSeeAll = new RecyclerAdapterSeeAll(getContext(), data);
            recyclerView.setAdapter(recyclerAdapterSeeAll);
        }
